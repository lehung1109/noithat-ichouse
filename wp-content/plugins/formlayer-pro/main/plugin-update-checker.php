...
class FormLayerUpdateChecker_3_2{
	 ...
	 * @return FromLayer_PucScheduler_3_2
	 */
	protected function createScheduler($checkPeriod) {
		return new FromLayer_PucScheduler_3_2($this, $checkPeriod);
	}
	...
	public function requestInfo($queryArgs = array()){
		...
		if ( !is_wp_error($status) ){
			$pluginInfo = FromLayerInfo_3_2::fromJson($result['body']);
			if ( $pluginInfo !== null ) {
	 ...
	 *
	 * @return FromLayerUpdate_3_2 An instance of FromLayerUpdate, or NULL when no updates are available.
	 */
	public function requestUpdate(){
		...
		$update = FromLayerUpdate_3_2::fromFromLayerInfo($pluginInfo);
	 ...
	 *
	 * @return FromLayerUpdate_3_2|null
	 */
	...
	public function getUpdateState() {
		...
		if ( isset($state, $state->update) && is_object($state->update) ) {
			$state->update = FromLayerUpdate_3_2::fromObject($state->update);
		}
		return $state;
	}
	...
	private function setUpdateState($state) {
		if ( isset($state->update) && is_object($state->update) && method_exists($state->update, 'toStdClass') ) {
			$update = $state->update; /** @var FromLayerUpdate_3_2 $update */
	 ...
	 * @param FromLayerUpdate_3_2 $updateToAdd
	 * @return StdClass
	 */
...
if ( !class_exists('FromLayerInfo_3_2', false) ):
...
class FromLayerInfo_3_2 {
	 ...
	 * @return FromLayerInfo_3_2|null New instance of FormLayerInfo, or NULL on error.
	 */
...
if ( !class_exists('FromLayerUpdate_3_2', false) ):
...
class FromLayerUpdate_3_2 {
	...
	/**
	 * Create a new instance of FromLayerUpdate from its JSON-encoded representation.
	 * 
	 * @param string $json
	 * @return FromLayerUpdate_3_2|null
	 */
	public static function fromJson($json){
		...
		$pluginInfo = FromLayerInfo_3_2::fromJson($json);
		if ( $pluginInfo != null ) {
			return self::fromFromLayerInfo($pluginInfo);
		} else {
			return null;
		}
	}
	...
	/**
	 * Create a new instance of FromLayerUpdate based on an instance of FormLayerInfo.
	 * Basically, this just copies a subset of fields from one object to another.
	 * 
	 * @param FromLayerInfo_3_2 $info
	 * @return FromLayerUpdate_3_2
	 */
	public static function fromFromLayerInfo($info){
		return self::fromObject($info);
	}
	
	/**
	 * Create a new instance of FromLayerUpdate by copying the necessary fields from 
	 * another object.
	 *  
	 * @param StdClass|FromLayerInfo_3_2|FromLayerUpdate_3_2 $object The source object.
	 * @return FromLayerUpdate_3_2 The new copy.
	 */
	 ...
	 * a FromLayerUpdate. Useful for serialization and caching, as it avoids
...
if ( !class_exists('FromLayer_PucScheduler_3_2', false) ):
 ...
 * @version 3.2
 */
class FromLayer_PucScheduler_3_2 {
